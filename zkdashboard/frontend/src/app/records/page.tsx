      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">{result.total} registros encontrados</p>
          </div>
        ...
        <form
          method="get"
          className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 mb-6 flex flex-wrap gap-4 items-end"
        >
          <div>
